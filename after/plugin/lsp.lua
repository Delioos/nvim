...
require('mason-lspconfig').setup({
  ensure_installed = { "rust_analyzer", "tsserver","dockerls","docker_compose_language_service", "graphql", "html", "htmx", "jsonls", "biome", "ltex", "lua_ls", "marksman", "intelephense", "pylsp", "jedi_language_server" , "sqlls", "tailwindcss", "vuels", "zls", "hydra_lsp"},
  handlers = {
...
vim.api.nvim_set_keymap('n', '<leader>ff', ":LspZeroFormat<CR>", {noremap = true, silent = true})
